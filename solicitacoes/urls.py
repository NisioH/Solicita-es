...
urlpatterns = [
    ...
    path('api/solicitacoes/atualizar/<str:numero>/',
         pedidos_views.atualizar_solicitacao, name='api_atualizar_solicitacao'),
    path('api/solicitacoes/deletar/<str:numero>/',
         pedidos_views.deletar_solicitacao, name='api_deletar_solicitacao'),
